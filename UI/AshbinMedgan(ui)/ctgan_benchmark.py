...
def evaluate_ctgan(real_data, synthetic_data, target_column=None):
    """
    ...
    if target_column and target_column in real_data.columns:
        ...
        # Use ffill() instead of fillna(method='ffill') to avoid warning
    ...
    if y_synthetic is not None:
        ...
        if y_synthetic.isna().any():
            mode_val = y_synthetic.mode()[0]  # Use mode()[0] instead of mode().iloc[0]
