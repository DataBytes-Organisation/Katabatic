from katabatic.katabatic_spi import *
import pandas as pd
...
class GanblrAdapter(KatabaticModelSPI):
    ...
    def generate(
        self, size=None
    ):  # Modify so that if size is not specified, default is the training sample size.
